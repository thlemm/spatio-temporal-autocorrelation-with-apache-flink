...
public class DataStreamSimulator03
{
    ...
    public static void main(String[] args) {
        ...
        long r = Integer.parseInt(args[0]);
        ...
        try {
            ...
            assert con != null;
            streamTable(con, databaseName, topic, producer, r);
            con.close();
    ...
    public static void streamTable(Connection con, String dbName, String topic, KafkaProducer<byte[], byte[]> producer, long r)
            throws SQLException {
